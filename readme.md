...
- [🚀 Kubernetes Starter Kit](#-kubernetes-starter-kit)
  ...
  - [🚀 Quick Start](#-quick-start)
    ...
    - [2. K3s Installation](#2-k3s-installation)
    - [Adding Additional Nodes](#adding-additional-nodes)
    - [2a. Build on macOS with Multipass + k3d](#2a-build-on-macos-with-multipass--k3d)
    - [Setting Up Lens (Optional but Recommended)](#setting-up-lens-optional-but-recommended)
    - [3. Networking Setup (Cilium)](#3-networking-setup-cilium)
    - [4. GitOps Setup (Argo CD - Part 1/2)](#4-gitops-setup-argo-cd---part-12)
    - [5. Monitoring Setup (Prometheus + Grafana + Loki + Tempo)](#5-monitoring-setup-prometheus--grafana--loki--tempo)
  - [🔒 Security Setup](#-security-setup)
    - [Design Philosophy: Frustration-Free Secrets](#design-philosophy-frustration-free-secrets)
    - [Container Hardening Examples](#container-hardening-examples)
    - [Cloudflare Integration](#cloudflare-integration)
      - [1. DNS API Token 🔑](#1-dns-api-token-)
      - [2. Cloudflare Tunnel 🌐](#2-cloudflare-tunnel-)
    - [Certificate Management](#certificate-management)
  - [🛠️ Final Deployment](#️-final-deployment)
